...
- Merge only after review (Joseph, 2026-09-24): a Codex review on `gpt-6-astra` or a higher model at reasoning effort medium or above, or, if that is unavailable, a review by Claude Opus 5.5 or Fable 5.1 or a higher model. Read and answer Greptile's comments first. Joseph's instruction to merge presupposes this review; it does not replace it.
