...
- Proposed a content-addressed review contract that links immutable evidence versions, proposals, review decisions, accepted events, frozen exports, and replay manifests by SHA-256 hashes. The design preserves the map-first dashboard while giving future command-line and agent clients a shared version protocol. It documents the gap between current duplicate, decision, and input hashes and a complete review history. Live schema and workflow behaviour remain unchanged. Files: `docs/development/content-addressed-review.md`, related portal and storage specifications, `docs/system-map.md`, `ROADMAP.md`, and `docs/development/README.md`.
