...
editors, devices, or review passes. The shared Sheet is the only durable pilot
record today, and it may legitimately contain multiple rows for the same place
when each row carries different source evidence, target-year evidence, or
