...
function context() {
  const rows = { users: [], agent_intake_receipts: [], tasks: [], evidence_drafts: [], evidence_versions: [], evidence_submission_receipts: [], site_occupancies: [], agent_reviews: [], task_events: [], review_decisions: [] };
  const db = {
    query(table) {
      let filters = [];
