...
// the brief's fictional continuation (section 4b): a kohekohe-shaped case
// with fictional dates — presbyterian from 1888, shared with methodists in the
// 1920s, desacralised 2014, an annual service after. the record (opened 1886,
// deconsecrated after the 1975 sale) is in section 4a
const KOHEKOHE = {
