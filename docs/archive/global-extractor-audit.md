...
- stages 3, 4, and 5 are now implemented in the canonical R pipeline:
  - `scripts/clean_global_places.R`
  - `scripts/deduplicate_global_places.R`
  - `scripts/build_global_review_queue.R`
- equivalent Python scripts remain in the repo only as transitional references
