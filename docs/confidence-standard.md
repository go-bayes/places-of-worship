...
Current version: 0.1.0. Adopted: 2026-09-24 by the project lead. Passages headed or marked *proposed* record design that the project lead has yet to rule on; everything else in this document is adopted.
