...
| Vanuatu province and area-council boundaries                                            | `scripts/build_vu_area_scaffold.R`                                                                                                          | `apps/regions/vu/data/adm1_2020.geojson`, `adm2_2020.geojson`, and the `area_summary_adm1/adm2.json` skeletons; manifest at `archive/geoboundaries-vut/` | Committed app data used by the Vanuatu research map. Boundaries from geoBoundaries gbOpen (ADM1 ODbL, ADM2 CC BY 3.0 IGO), pinned to release `9469f09`. The area summaries are data-pending skeletons: 6 provinces and 65 area councils by census years 2009 and 2020, religion values null until a source exists. | Drop per-area 2009/2020 religious-affiliation counts into the summary rows (no schema change needed); the 2020 VNSO provincial tables are PDF-only today. |
