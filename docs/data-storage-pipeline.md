...
| New Zealand annual OSM history, 2013-2025                                               | `scripts/build_nz_osm_temporal_candidates.R`                                                                                                 | `data/intermediate/nz_osm_temporal/`                                                                                       | Temporary working files only. The first strict national run produced 4,777 year-difference rows and cleaned snapshot counts of 775 for 2013, 2,012 for 2018, 3,335 for 2023, and 3,350 for 2025. A later cached run produced 1,438 OSM date-tag rows. | Promote the CSV/GeoJSON outputs and retained source files to project-owned storage, compute hashes, and commit a file record before importing any rows into Convex or assigning them to an RA. |
