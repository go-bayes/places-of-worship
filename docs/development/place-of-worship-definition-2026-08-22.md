...
> Historical status: version 0.0.1 was superseded on 2026-08-27. The complete discussion draft remains below as an immutable version snapshot. Current instructions should use the [canonical operational definition](../operational-definition.md); version 0.1.0 is preserved in its own [dated snapshot](place-of-worship-definition-2026-08-27.md).
