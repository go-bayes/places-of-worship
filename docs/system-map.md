...
| Shared Task List | Who is working on what, task status, provisional closure, assignments, nominations, and shared task history. | Accepted research data or master writes. | Convex task state; Sheets only as fallback/debug export. |
