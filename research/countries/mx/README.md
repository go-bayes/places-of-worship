...
Religious-affiliation percent by municipality, 2000-2020, on 2020 Marco Geoestadistico municipal boundaries.

## Build recipe

1. Extract: parse ITER files for `PCATOLICA`, `PRO_CRIEVA`, `POTRAS_REL`, and `PSIN_RELIG`, aggregate localities to municipality, and retain INEGI source metadata.
...
- Category labels changed across waves; publish a category crosswalk before trend layers.
