...
- **Côte d’Ivoire (CI)** — census affiliation; 1988–2021, with a directly usable 2021 wave; sub-prefecture or commune, region, and district; **verified route**: the official [2021 religion tables](https://rp2021.anstat.ci/wp-content/uploads/2023/09/TABLEAUX-11_DE-BASES_RP-RELIGION.pdf) publish local rows.
